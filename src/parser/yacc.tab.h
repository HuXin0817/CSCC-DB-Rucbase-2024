...
#ifndef YY_YY_USERS_HUXIN_RMDB_SRC_PARSER_YACC_TAB_H_INCLUDED
# define YY_YY_USERS_HUXIN_RMDB_SRC_PARSER_YACC_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    STATIC_CHECKPOINT = 292,       /* STATIC_CHECKPOINT  */
    CRASH = 293,                   /* CRASH  */
    MAX = 294,                     /* MAX  */
    MIN = 295,                     /* MIN  */
    AVG = 296,                     /* AVG  */
    ...
    NOT = 303,                     /* NOT  */
    LOAD = 304,                    /* LOAD  */
    SIGN_ADD = 305,                /* SIGN_ADD  */
    SIGN_SUB = 306,                /* SIGN_SUB  */
    LEQ = 307,                     /* LEQ  */
    NEQ = 308,                     /* NEQ  */
    GEQ = 309,                     /* GEQ  */
    T_EOF = 310,                   /* T_EOF  */
    OUTPUT_FILE = 311,             /* OUTPUT_FILE  */
    ON = 312,                      /* ON  */
    OFF = 313,                     /* OFF  */
...
#endif /* !YY_YY_USERS_HUXIN_RMDB_SRC_PARSER_YACC_TAB_H_INCLUDED  */
